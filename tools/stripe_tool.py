...
class StripeTool(SalesTool):
    ...
    async def execute(self, action: str, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Execution error: {e!s}")
    ...
    async def _create_customer(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to create customer: {e!s}")
    ...
    async def _get_customer(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to get customer: {e!s}")
    ...
    async def _update_customer(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to update customer: {e!s}")
    ...
    async def _list_customers(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to list customers: {e!s}")
    ...
    async def _create_payment_intent(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to create payment intent: {e!s}")
    ...
    async def _get_payment_intent(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to get payment intent: {e!s}")
    ...
    async def _confirm_payment_intent(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to confirm payment intent: {e!s}")
    ...
    async def _create_subscription(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to create subscription: {e!s}")
    ...
    async def _get_subscription(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to get subscription: {e!s}")
    ...
    async def _update_subscription(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to update subscription: {e!s}")
    ...
    async def _cancel_subscription(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to cancel subscription: {e!s}")
    ...
    async def _list_subscriptions(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to list subscriptions: {e!s}")
    ...
    async def _create_product(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to create product: {e!s}")
    ...
    async def _get_product(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to get product: {e!s}")
    ...
    async def _list_products(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to list products: {e!s}")
    ...
    async def _create_price(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to create price: {e!s}")
    ...
    async def _get_price(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to get price: {e!s}")
    ...
    async def _list_prices(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to list prices: {e!s}")
    ...
    async def _create_invoice(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to create invoice: {e!s}")
    ...
    async def _get_invoice(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to get invoice: {e!s}")
    ...
    async def _send_invoice(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to send invoice: {e!s}")
    ...
    async def _list_invoices(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to list invoices: {e!s}")
    ...
    async def _get_balance(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to get balance: {e!s}")
    ...
    async def _list_charges(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to list charges: {e!s}")
    ...
    async def _refund_payment(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to refund payment: {e!s}")
