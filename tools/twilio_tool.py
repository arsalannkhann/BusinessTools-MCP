...
class TwilioTool(SalesTool):
    ...
    async def execute(self, action: str, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            # Utility Operations
            if action == "check_phone_number":
                return await self._check_phone_number(params)
            if action == "get_available_numbers":
    ...
    async def _send_sms(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            try:
                ...
                return self._create_error_result(f"Invalid recipient phone number: {e!s}")
            ...
            try:
                ...
                return self._create_error_result(f"Invalid sender phone number: {e!s}")
            ...
            return self._create_error_result(f"Failed to send SMS: {e!s}")
    ...
    async def _send_whatsapp(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to send WhatsApp: {e!s}")
    ...
    async def _make_call(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to make call: {e!s}")
    ...
    async def _send_bulk_sms(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to send bulk SMS: {e!s}")
    ...
    async def _get_message_history(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to get message history: {e!s}")
    ...
    async def _get_call_history(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to get call history: {e!s}")
    ...
    async def _check_phone_number(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Phone number validation failed: {e!s}")
    ...
    async def _get_account_usage(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to get account usage: {e!s}")
    ...
    async def _get_available_numbers(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to get available numbers: {e!s}")
