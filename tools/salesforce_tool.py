...
class SalesforceTool(SalesTool):
    ...
    async def execute(self, action: str, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Salesforce operation failed: {e!s}")
    ...
    async def _create_lead(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to create lead: {e!s}")
    ...
    async def _get_lead(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Lead not found: {e!s}")
    ...
    async def _update_lead(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to update lead: {e!s}")
    ...
    async def _list_leads(self, params: dict[str, Any]) -> ToolResult:
        ...
        query = "SELECT Id, FirstName, LastName, Email, Company, Status, CreatedDate FROM Lead"
        if where_clause:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to list leads: {e!s}")
    ...
    async def _convert_lead(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to convert lead: {e!s}")
    ...
    async def _create_opportunity(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to create opportunity: {e!s}")
    ...
    async def _get_opportunity(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Opportunity not found: {e!s}")
    ...
    async def _list_opportunities(self, params: dict[str, Any]) -> ToolResult:
        ...
        query = "SELECT Id, Name, StageName, Amount, CloseDate, AccountId, CreatedDate FROM Opportunity"
        if where_clause:
            query += f" WHERE {where_clause}"
        query += f" ORDER BY {order_by} LIMIT {limit}"
        ...
        try:
            ...
            return self._create_error_result(f"Failed to list opportunities: {e!s}")
    ...
    async def _create_account(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to create account: {e!s}")
    ...
    async def _get_account(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Account not found: {e!s}")
    ...
    async def _search(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Search failed: {e!s}")
    ...
    async def _custom_query(self, params: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Query failed: {e!s}")
