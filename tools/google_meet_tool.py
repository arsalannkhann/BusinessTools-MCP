...
class GoogleMeetTool(SalesTool):
    ...
    async def execute(self, action: str, params: Dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            elif action == "create_instant_meeting":
            ...
            return self._create_error_result(f"Google Meet operation failed: {str(e)}")
    ...
    async def _create_meeting(self, params: Dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to create Google Meet meeting: {str(e)}")
    ...
    async def _create_instant_meeting(self, params: Dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to create instant meeting: {str(e)}")
    ...
    async def _get_meeting(self, params: Dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to get meeting: {str(e)}")
    ...
    async def _update_meeting(self, params: Dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to update meeting: {str(e)}")
    ...
    async def _end_meeting(self, params: Dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            return self._create_error_result(f"Failed to end meeting: {str(e)}")
