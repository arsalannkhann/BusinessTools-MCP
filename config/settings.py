...
class Settings:
    ...
    def _init_google_config(self):
        ...
        # Google API Keys
        self.google_cloud_api = self.get("GOOGLE_CLOUD_API")
        self.gemini_api_key = self.get("GEMINI_API_KEY")
    ...
    def _init_crm_config(self):
        ...
        self.people_data_labs_key = self.get("PEOPLE_DATA_LABS_KEY")
    ...
    def _init_communication_config(self):
        ...
        # Social Media
        self.twitter_bearer_token = self.get("TWITTER_BEARER_TOKEN")
        self.twitter_api_key = self.get("TWITTER_API_KEY")
        self.twitter_api_secret = self.get("TWITTER_API_SECRET")

        # Knowledge Base
        self.notion_key = self.get("NOTION_KEY")
